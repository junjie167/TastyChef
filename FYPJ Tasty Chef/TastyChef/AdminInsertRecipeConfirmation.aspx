<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="AdminInsertRecipeConfirmation.aspx.cs" Inherits="TastyChef.AdminInsertRecipeConfirmation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="stepContent">
        ...
        <div id="confirmationButton">
            <asp:Button ID="BtnConfirmation" runat="server" Text="Confirmation" CssClass="stepButton" BackColor="#009999" ForeColor="White" />
        </div>
    </div>
    <div id="mainContent">
        <div id="content">
                            ...
                            <table class="table">
                                <tr>
                                    <td>    <asp:Label ID="Label45" runat="server" CssClass="nutritionDataContent" Text="Total Calories:" Font-Bold="True" ></asp:Label>
                                        ...
                                        <asp:Label ID="Label46" runat="server" CssClass="nutritionDataContent" Font-Bold="True" Text="Kcal"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td><hr /></td>
                                ...
                                <tr>
                                    <td> <asp:Label ID="Label38" runat="server" CssClass="nutritionDataContent" Text="Total Fat:" Font-Bold="True"></asp:Label>
                                        ...
                                        <asp:Label ID="Label47" runat="server" CssClass="nutritionDataContent" Font-Bold="True" Text="grams"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td><asp:Label ID="Label36" runat="server" CssClass="nutritionDataContent" Text="Saturated Fat:"></asp:Label>
                                ...
                                <tr>
                                    <td>  <asp:Label ID="Label44" runat="server" CssClass="nutritionDataContent" Text="Carbohydrates:" Font-Bold="True"></asp:Label>
                ...
                <div id="assignDayBody">
                    ...
                    <div class="Part">
                        ...
                        <div class="body">
                            <br />
                            <br />
                            <asp:Label ID="LblSchedule" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="30px" ForeColor="Black"></asp:Label>
                        </div>
                    </div>
                </div>
                <div id="step5BackButton">
                    <asp:Button ID="Button5" runat="server" Text="Go back to step 5" CssClass="bigButton" OnClick="Button5_Click" />
                </div>
            </div>
            <div id="nextButtonContent">
                <asp:Button ID="BtnStep1Next" runat="server" Text="Create Recipe" CssClass="nextButton" OnClick="BtnStep1Next_Click" Width="300px" />
